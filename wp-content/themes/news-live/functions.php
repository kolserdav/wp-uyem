...
if ( ! function_exists( 'newslive_enqueue_styles' ) ) :
	...
	function newslive_enqueue_styles() {
		...
		wp_enqueue_style( 'newslive-style', get_stylesheet_directory_uri() . '/style.css', array( 'newsup-style-parent' ), '1.0' );
		wp_enqueue_style('bootstrap', get_template_directory_uri() . '/css/bootstrap.css');
		wp_dequeue_style( 'newsup-default',get_template_directory_uri() .'/css/colors/default.css');
		wp_enqueue_style( 'newslive-default-css', get_stylesheet_directory_uri()."/css/colors/default.css" );
		if(is_rtl()){
...
// custom header Support
		...
		'top_right' => __( 'Top Header menu', 'news-live' ),
		) );
} 
...
function newslive_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Front-Page Left Sidebar Section', 'news-live'),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Front-Page Right Sidebar Section', 'news-live'),
...
<?php }
add_action( 'wp_footer', 'newslive_menu' );